...
@interface ChatViewController ()<UITableViewDataSource, UITableViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, SRRefreshDelegate, IChatManagerDelegate, DXChatBarMoreViewDelegate, DXMessageToolBarDelegate, LocationViewDelegate, EMCDDeviceManagerDelegate,EMCallManagerDelegate,EMCallManagerCallDelegate>
{
...
- (void)handleCallNotification:(NSNotification *)notification
{
    ...
    if ([object isKindOfClass:[NSDictionary class]]) {
        ...
        [self callOutWithChatter:notification];
    }
    else
    {
        //结束call
...
- (UITableView *)tableView
{
    if (_tableView == nil) {
        ...
        _tableView.backgroundColor = RGBACOLOR(234, 234, 234, 1);
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if(scrollView.isDragging) [self.view endEditing:YES];
}
