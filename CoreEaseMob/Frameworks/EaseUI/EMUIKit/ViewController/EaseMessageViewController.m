...
@interface EaseMessageViewController ()<EMCallManagerDelegate>
{
...
- (void)moreViewAudioCallAction:(EaseChatBarMoreView *)moreView
{
    ...
    [self callOutWithChatter:self.conversation.chatter type:eCallSessionTypeAudio];
}
...
- (void)moreViewVideoCallAction:(EaseChatBarMoreView *)moreView
{
    ...
    [self callOutWithChatter:self.conversation.chatter type:eCallSessionTypeVideo];
}
